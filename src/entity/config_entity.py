...
class Data_Transformation_Config():
    def __init__(self,trainingpipelineconfig:TrainingPipelineConfig):
        ...
        self.transformation_train_file_path=os.path.join(self.data_transformation_dir,training_pipeline.DATA_TRANSFORMATION_TRANSFORMED_DATA_DIR
...
class ModelTrainerConfig:
    def __init__(self,trainingpipelineconfig:TrainingPipelineConfig):
        ...
        self.trained_model_file_path=os.path.join(
            ...
            training_pipeline.MODEL_TRAINER_TRAINED_MODEL_NSME
        )
